...
| [streamlit-fx-analysis](https://github.com/sfc-gh-kmotokubota/streamlit-fx-analysis) | Multi-Currency FX analysis with Cortex AI |
| [streamlit-fx-forecast](https://github.com/sfc-gh-kmotokubota/streamlit-fx-forecast) | FX time-series forecast with ML.FORECAST |
| [streamlit-us-stock-analysis](https://github.com/sfc-gh-kmotokubota/streamlit-us-stock-analysis) | US stock analysis with Marketplace data |
| [streamlit-cpi-analysis](https://github.com/sfc-gh-kmotokubota/streamlit-cpi-analysis) | CPI analytics with AI-powered insights |
| [streamlit-cpi-fx-dashboard](https://github.com/sfc-gh-kmotokubota/streamlit-cpi-fx-dashboard) | CPI & FX rate trends dashboard |
| [streamlit-jpnews-sentiment](https://github.com/sfc-gh-kmotokubota/streamlit-jpnews-sentiment) | Japan stock news sentiment analysis |
| [streamlit-data-loader-explorer](https://github.com/sfc-gh-kmotokubota/streamlit-data-loader-explorer) | Multi-format file upload & visual query builder |
...
| [zero-to-snowflake-jp](https://github.com/sfc-gh-kmotokubota/zero-to-snowflake-jp) | Zero to Snowflake ハンズオン日本語版 |
| [sfguide-data-apps-summit-lab](https://github.com/sfc-gh-kmotokubota/sfguide-data-apps-summit-lab) | Data Apps Summit Lab ハンズオン |
